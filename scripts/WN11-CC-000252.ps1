<#
.SYNOPSIS
    Remediates WN11-CC-000252 by disabling Windows Game Recording and Broadcasting.
...
.USAGE
    ...
    Example syntax:
    PS C:\> .\__remediation_template(WN11-CC-000252).ps1
...
# Verification
Get-ItemProperty -Path $RegPath -Name $ValueName | Select-Object AllowGameDVR